...
export default function IntroOverlay({ onEnter }: IntroOverlayProps) {
  ...
  const handleEnter = () => {
    if (phase === 'exiting' || phase === 'reveal') return;
    setPhase('exiting');
            ...
            <AnimatePresence mode="wait">
              ...
              {phase === 'cta' && (
                ...
                >
                  ...
                  >
                    Prête à revivre notre histoire ?
                  </p>
                  <motion.button
                    onClick={handleEnter}
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="group relative px-12 py-5 rounded-full overflow-hidden animate-glow-pulse cursor-pointer"
                    style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                  >
                  ...
                  <p
                    ...
                    style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                  >
                    Mets le son 🔊 pour vivre l'expérience
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
